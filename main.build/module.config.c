...
static PyCodeObject *code_objects_db67f36cd2e34cc74eeec2d9cbd14bc2;

static void createModuleCodeObjects(void) {
    module_filename_obj = MAKE_RELATIVE_PATH(mod_consts[1]); CHECK_OBJECT(module_filename_obj);
    code_objects_db67f36cd2e34cc74eeec2d9cbd14bc2 = MAKE_CODE_OBJECT(module_filename_obj, 1, CO_OPTIMIZED | CO_NEWLOCALS | CO_VARARGS | CO_VARKEYWORDS, mod_consts[5], mod_consts[5], mod_consts[7], NULL, 0, 0, 0);
}
#endif

// The module function declarations.
static PyObject *MAKE_FUNCTION_config$$$function__1_lambda(PyThreadState *tstate);
...
static PyObject *MAKE_FUNCTION_config$$$function__1_lambda(PyThreadState *tstate) {
    struct Nuitka_FunctionObject *result = Nuitka_Function_New(
        ...
        NULL,
#endif
        code_objects_db67f36cd2e34cc74eeec2d9cbd14bc2,
        NULL,
#if PYTHON_VERSION >= 0x300
        NULL,
        NULL,
...
// Set the "__spec__" value
    ...
    // Module code.
    {
        ...
        tmp_args_element_value_3 = MAKE_FUNCTION_config$$$function__1_lambda(tstate);
        ...
        UPDATE_STRING_DICT1(moduledict_config, (Nuitka_StringObject *)mod_consts[6], tmp_assign_source_1);
    }
