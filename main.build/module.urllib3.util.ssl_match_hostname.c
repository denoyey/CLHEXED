...
static PyCodeObject *code_objects_bfb784708a52aff514e497f3a9b9897c;
static PyCodeObject *code_objects_777b2a7c3746cb584bf35d9f8ab55208;
static PyCodeObject *code_objects_a950e43a40b69b2ae37f85b5766bc395;
static PyCodeObject *code_objects_7cf591337fb421cd12980b8b4da8918d;

static void createModuleCodeObjects(void) {
    module_filename_obj = MAKE_RELATIVE_PATH(mod_consts[81]); CHECK_OBJECT(module_filename_obj);
    code_objects_bfb784708a52aff514e497f3a9b9897c = MAKE_CODE_OBJECT(module_filename_obj, 1, CO_FUTURE_ANNOTATIONS, mod_consts[82], mod_consts[82], NULL, NULL, 0, 0, 0);
    code_objects_777b2a7c3746cb584bf35d9f8ab55208 = MAKE_CODE_OBJECT(module_filename_obj, 24, CO_OPTIMIZED | CO_NEWLOCALS | CO_FUTURE_ANNOTATIONS, mod_consts[37], mod_consts[37], mod_consts[83], NULL, 3, 0, 0);
    code_objects_a950e43a40b69b2ae37f85b5766bc395 = MAKE_CODE_OBJECT(module_filename_obj, 80, CO_OPTIMIZED | CO_NEWLOCALS | CO_FUTURE_ANNOTATIONS, mod_consts[41], mod_consts[41], mod_consts[84], NULL, 2, 0, 0);
    code_objects_7cf591337fb421cd12980b8b4da8918d = MAKE_CODE_OBJECT(module_filename_obj, 95, CO_OPTIMIZED | CO_NEWLOCALS | CO_FUTURE_ANNOTATIONS, mod_consts[80], mod_consts[80], mod_consts[85], NULL, 3, 0, 0);
}
#endif
...
static PyObject *impl_urllib3$util$ssl_match_hostname$$$function__2__ipaddress_match(PyThreadState *tstate, struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_frame_urllib3$util$ssl_match_hostname$$$function__2__ipaddress_match)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_frame_urllib3$util$ssl_match_hostname$$$function__2__ipaddress_match = MAKE_FUNCTION_FRAME(tstate, code_objects_a950e43a40b69b2ae37f85b5766bc395, module_urllib3$util$ssl_match_hostname, sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
...
static PyObject *impl_urllib3$util$ssl_match_hostname$$$function__3_match_hostname(PyThreadState *tstate, struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_frame_urllib3$util$ssl_match_hostname$$$function__3_match_hostname)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_frame_urllib3$util$ssl_match_hostname$$$function__3_match_hostname = MAKE_FUNCTION_FRAME(tstate, code_objects_7cf591337fb421cd12980b8b4da8918d, module_urllib3$util$ssl_match_hostname, sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    branch_no_2:;
    {
        ...
        frame_frame_urllib3$util$ssl_match_hostname$$$function__3_match_hostname->m_frame.f_lineno = 122;
    ...
    }
    {
        ...
        frame_frame_urllib3$util$ssl_match_hostname$$$function__3_match_hostname->m_frame.f_lineno = 128;
    ...
    branch_yes_4:;
    {
        ...
        frame_frame_urllib3$util$ssl_match_hostname$$$function__3_match_hostname->m_frame.f_lineno = 133;
        {
    ...
    branch_yes_6:;
    {
        ...
        frame_frame_urllib3$util$ssl_match_hostname$$$function__3_match_hostname->m_frame.f_lineno = 137;
        {
            PyObject *call_args[] = {tmp_args_element_value_5, tmp_args_element_value_6};
    ...
    branch_yes_8:;
    {
        ...
        frame_frame_urllib3$util$ssl_match_hostname$$$function__3_match_hostname->m_frame.f_lineno = 144;
    ...
    branch_yes_9:;
    {
        ...
        frame_frame_urllib3$util$ssl_match_hostname$$$function__3_match_hostname->m_frame.f_lineno = 147;
        {
    ...
    branch_yes_11:;
    {
        ...
        tmp_mod_expr_right_1 = MAKE_TUPLE_EMPTY(tstate, 2);
        {
            ...
            frame_frame_urllib3$util$ssl_match_hostname$$$function__3_match_hostname->m_frame.f_lineno = 154;
            {
        ...
        frame_frame_urllib3$util$ssl_match_hostname$$$function__3_match_hostname->m_frame.f_lineno = 152;
        tmp_raise_type_input_1 = CALL_FUNCTION_WITH_SINGLE_ARG(tstate, tmp_called_value_8, tmp_args_element_value_9);
    ...
    branch_yes_12:;
    {
        ...
        frame_frame_urllib3$util$ssl_match_hostname$$$function__3_match_hostname->m_frame.f_lineno = 157;
        tmp_raise_type_input_2 = CALL_FUNCTION_WITH_SINGLE_ARG(tstate, tmp_called_value_10, tmp_args_element_value_12);
    ...
    branch_no_12:;
    {
        ...
        frame_frame_urllib3$util$ssl_match_hostname$$$function__3_match_hostname->m_frame.f_lineno = 159;
        tmp_raise_type_input_3 = CALL_FUNCTION_WITH_POS_ARGS1(tstate, tmp_called_value_11, mod_consts[50]);
...
static PyObject *MAKE_FUNCTION_urllib3$util$ssl_match_hostname$$$function__1__dnsname_match(PyThreadState *tstate, PyObject *defaults, PyObject *annotations) {
    struct Nuitka_FunctionObject *result = Nuitka_Function_New(
        ...
        NULL,
#endif
        code_objects_777b2a7c3746cb584bf35d9f8ab55208,
        defaults,
#if PYTHON_VERSION >= 0x300
        NULL,
        annotations,
...
static PyObject *MAKE_FUNCTION_urllib3$util$ssl_match_hostname$$$function__2__ipaddress_match(PyThreadState *tstate, PyObject *annotations) {
    struct Nuitka_FunctionObject *result = Nuitka_Function_New(
        ...
        NULL,
#endif
        code_objects_a950e43a40b69b2ae37f85b5766bc395,
        NULL,
#if PYTHON_VERSION >= 0x300
        NULL,
        annotations,
...
static PyObject *MAKE_FUNCTION_urllib3$util$ssl_match_hostname$$$function__3_match_hostname(PyThreadState *tstate, PyObject *defaults, PyObject *annotations) {
    struct Nuitka_FunctionObject *result = Nuitka_Function_New(
        ...
        NULL,
#endif
        code_objects_7cf591337fb421cd12980b8b4da8918d,
        defaults,
#if PYTHON_VERSION >= 0x300
        NULL,
        annotations,
...
// Set the "__spec__" value
    ...
    frame_frame_urllib3$util$ssl_match_hostname = MAKE_MODULE_FRAME(code_objects_bfb784708a52aff514e497f3a9b9897c, module_urllib3$util$ssl_match_hostname);
    ...
    branch_end_1:;
    {
        ...
        tmp_res = PyObject_SetItem(locals_urllib3$util$ssl_match_hostname$$$class__1_CertificateError_20, mod_consts[72], tmp_dictset_value);
        if (tmp_res != 0) {
            assert(HAS_ERROR_OCCURRED(tstate));
        ...
        tmp_res = PyObject_SetItem(locals_urllib3$util$ssl_match_hostname$$$class__1_CertificateError_20, mod_consts[73], tmp_dictset_value);
        if (tmp_res != 0) {
            assert(HAS_ERROR_OCCURRED(tstate));
        ...
        tmp_res = PyObject_SetItem(locals_urllib3$util$ssl_match_hostname$$$class__1_CertificateError_20, mod_consts[74], tmp_dictset_value);
        if (tmp_res != 0) {
            assert(HAS_ERROR_OCCURRED(tstate));
